...
//create figure and img elements for fifth image
  ...
  //create img element for the fifth image to preview 
...
function createEventListeners() {
    ...
    //the leftArrow() function will be executed when the user clicks the left navigator arrow button
    ...
    //the rightArrow() function will be executed when user clicks the right navigation arrow button
